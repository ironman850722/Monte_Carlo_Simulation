...
main( int argc, char *argv[ ] )
{
	...
	float *vs  = (float*)malloc(NUMTRIALS * sizeof(float));//new float [NUMTRIALS];
	float *ths = (float*)malloc(NUMTRIALS * sizeof(float));//new float [NUMTRIALS];
	float * gs = (float*)malloc(NUMTRIALS * sizeof(float));//new float [NUMTRIALS];
	float * hs = (float*)malloc(NUMTRIALS * sizeof(float));//new float [NUMTRIALS];
	float * ds = (float*)malloc(NUMTRIALS * sizeof(float));//new float [NUMTRIALS];
